...
insert into public.ff_pgtap_ctx (name, value) values
  ('versions', '{"dataVersion":"data-v1","ratingVersion":"ratings-v3.12","positionNormalizationVersion":"position-v3","engineVersion":"m3-engine-v21","bracketVersion":"bracket-m3-v3","scheduleVersion":"schedule-v1","seedDerivationVersion":"seed-v1","classicRollVersion":"classic-roll-v1","profileVersion":"2010s-fixed-v1","multiplayerVersion":"fixed-five-multiplayer-v1","autopickVersion":"fixed-five-autopick-v1"}'),
