...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_rooms' and policyname='members may read their room') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_room_commands' and policyname='members may read their room commands') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_private_decisions' and policyname='members may read private decisions only after reveal') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_private_decisions' and policyname='members may read their own pending private decision') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_checkpoint_attestations' and policyname='members may read checkpoint attestations') then
...
do $$ begin
  if not exists (select 1 from pg_policies where schemaname='public' and tablename='season_deadlines' and policyname='members may read deadlines') then
...
revoke all on function public.season_room_create(text, text) from anon;
grant execute on function public.season_room_create(text, text) to service_role;
