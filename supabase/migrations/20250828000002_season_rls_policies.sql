-- M2.7 RLS update policies for direct client updates (reclaim/surrender/close) and join attempts
-- These complement Edge Functions which use service_role and bypass RLS, but allow fallback direct updates for local dev
