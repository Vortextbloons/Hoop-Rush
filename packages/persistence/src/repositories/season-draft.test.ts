...
import { buildChallengeRun, buildClassicDraftState, buildFixtureEvaluations, buildSeasonAiAssignments, buildSeasonAiPools, buildSeasonDraftState, buildSeasonLeague, buildSeasonRosters, buildSeasonRotation, fixtureGenerationDigest, } from '@hoop-rush/test-fixtures';
import { SEASON_AI_VERSION, SEASON_ROSTER_GENERATION_VERSION, SEASON_ROTATION_VERSION, seasonDraftStateSchema, seedSchema, type SeasonDraftCommandRecord, type SeasonLeagueGenerationResult, } from '@hoop-rush/data-contracts';
import { DexieChallengeRepository } from './dexie.ts';
import { DexieSeasonDraftRepository } from './season-draft.ts';
import { recordFromState, SEASON_DRAFT_RECORD_ID, type StoredSeasonDraft, } from '../schemas/season-draft-record.ts';
