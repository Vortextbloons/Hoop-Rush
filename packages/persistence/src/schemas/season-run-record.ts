import { z } from 'zod';
import { franchiseIdSchema, postseasonGameIdSchema, seasonAcceptedBlockSchema, seasonActiveRunIndexSchema, seasonAlmanacSchema, seasonBlockRecapSchema, seasonCheckpointDigestSchema, seasonCheckpointStateSchema, seasonCommandLogEntrySchema, seasonCommandLogSchema, seasonCompactInjuryEventSchema, seasonControlSchema, seasonEffectsStateSchema, seasonFreeAgencyStateSchema, seasonGameSimulationResultSchema, seasonGameSummarySchema, seasonCampaignStateSchema, seasonHealthStateSchema, seasonInfluenceStateSchema, seasonInvalidRosterInterruptionSchema, seasonObjectiveStateSchema, seasonPendingBlockCandidateSchema, seasonPlayerAggregateSchema, seasonPostseasonPhaseSchema, seasonPostseasonSummarySchema, seasonRetainedGameDetailSchema, seasonRosterSchema, seasonRotationSchema, seasonRotationSetDigestSchema, seasonRunCompletionSchema, seasonRunSchema, seasonRunStageSchema, seasonStandingsSchema, seasonTeamAggregateSchema, seasonTradeStateSchema, seasonTransactionEntrySchema, seasonOwnershipSchema, seasonAwardsSchema, seasonPostseasonStateSchema, SEASON_ROSTER_MAX_SIZE, SEASON_ROSTER_MIN_SIZE, SEASON_RUN_SAVE_SCHEMA_VERSION, SEASON_TEAM_COUNT, } from '@hoop-rush/data-contracts';
...
export type StoredSeasonPostseasonSummaryRow = z.infer<typeof storedSeasonPostseasonSummaryRowSchema>;
