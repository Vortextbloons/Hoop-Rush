import { emptySeasonPlayerAggregate, emptySeasonTeamAggregate, seasonEffectsStateSchema, type SeasonEffectsState, type SeasonGameSummary, type SeasonLeague, type SeasonPairChemistryState, type SeasonPlayerAggregate, type SeasonRoster, type SeasonRotation, type SeasonTeamAggregate, } from '@hoop-rush/data-contracts';
import { WINDOW_BLOCK_INDEX_TO_INDEX, createInitialSeasonInfluenceState, foldSeasonPlayerAggregates, foldSeasonTeamAggregates, reconstructSeasonGames, reduceSeasonStandings, seasonRotationSetDigest, seasonRunStateDigest as engineSeasonRunStateDigest, } from '@hoop-rush/engine';
...
function paddedTeamAggregates(league: SeasonLeague, summaries: readonly SeasonGameSummary[]): SeasonTeamAggregate[] {
...
function paddedPlayerAggregates(rosters: readonly SeasonRoster[], summaries: readonly SeasonGameSummary[]): SeasonPlayerAggregate[] {
