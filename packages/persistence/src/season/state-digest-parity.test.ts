...
import { buildFixtureEffectsState, buildFixtureRun, buildFixtureSchedule, buildFixtureStateDigest, } from '../testing/season-run-fixture.ts';
const SEED = 'a1b2c3d4e5f60718293a4b5c6d7e8f9a';
function digestFactsFromRun(run: ReturnType<typeof buildFixtureRun>, effects = buildFixtureEffectsState(run.rosters)): SeasonRunStateDigestFacts {
    return {
