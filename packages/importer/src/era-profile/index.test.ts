...
describe('computePoolShotMix', () => {
    const player = (usage: number, zones: Pick<PoolPlayerLike['tendencies'], 'rimFrequency' | 'shortMidFrequency' | 'longMidFrequency' | 'cornerThreeFrequency' | 'aboveBreakThreeFrequency'>): PoolPlayerLike => ({
