import type { EraSimulationProfile, FixedFiveDuelResult, GameResult, Seed, SimulationTeam, } from '@hoop-rush/data-contracts';
...
export function simulateDuelSeries(input: DuelSimulationInput, context: EngineContext): DuelSimulationOutput {
