...
import { SEASON_OBJECTIVE_CATALOG, type SeasonGameSummary, type SeasonHealthState, type SeasonInjuryRecord, } from '@hoop-rush/data-contracts';
...
describe('M2.5 block pipeline with injuries', () => {
    ...
    it('folds the locked objective, influence grants, and transactions into the candidate', () => {
        ...
        expect(candidate.recap.influenceBalance.humanBalance).toBe(candidate.influence.balances['lakers'] ?? 0);
