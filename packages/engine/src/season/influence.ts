import { SEASON_INFLUENCE_CAP, SEASON_INFLUENCE_FLOOR, type SeasonInfluenceLedgerEntry, type SeasonInfluenceState, type SeasonTransactionEntry, } from '@hoop-rush/data-contracts';
