import { SEASON_MINUTE_POLICY_VERSION, SEASON_ROTATION_PRESET_TARGETS, SEASON_ROTATION_VERSION, type SeasonMinutePolicyStrategy, type SeasonRotation, } from '@hoop-rush/data-contracts';
