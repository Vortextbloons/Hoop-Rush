...
import { SEASON_COMMITTED_SCHEDULE_SEED, SEASON_GAME_COUNT, SEASON_ROUND_COUNT, seasonScheduleSchema, } from '@hoop-rush/data-contracts';
...
describe('generateSeasonSchedule', () => {
    ...
    it('rejects a league without 30 teams', () => {
        ...
        expect(() => generateSeasonSchedule({ league: short, seed: seedFromString('short') })).toThrow();
    });
});
