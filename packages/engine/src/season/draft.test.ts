...
import { SEASON_DRAFT_OFFER_SIZE, SEASON_DRAFT_SAFE_MINIMUM, SEASON_ROSTER_TARGETS_VERSION, SEASON_ROTATION_VERSION, seasonDraftStateSchema, seasonLeagueGenerationResultSchema, seasonNamespaceSeed, seasonDigestHex, type SeasonDraftCandidate, type SeasonDraftCatalog, type SeasonDraftCommand, type SeasonDraftCommandRecord, type SeasonDraftState, type SeasonDraftAcceptedRecord, type SeasonDraftRejectedRecord, type SeasonDraftOffer, type SeasonAiPool, type SeasonGenerationDiagnostics, type SeasonLeague, type SeasonLeagueGenerationResult, } from '@hoop-rush/data-contracts';
...
function createSolo(catalog: SeasonDraftCatalog = CATALOG, league: SeasonLeague = LEAGUE, rootSeed = SEED) {
...
function createDuo(catalog: SeasonDraftCatalog = FULL_CATALOG, league: SeasonLeague = LEAGUE, rootSeed = SEED) {
    return applySeasonDraftCommand(null, catalog, cmd('c-create', 0, {
        kind: 'create-season-draft',
        runId: 'run-1',
        rootSeed,
...
function playToFinalized(catalog: SeasonDraftCatalog, league: SeasonLeague, rootSeed: string, deps: SeasonAiGenerationDeps, ids: string[], commandIdPrefix: string): SeasonDraftState {
...
function playFullDraft(catalog: SeasonDraftCatalog, league: SeasonLeague, rootSeed: string, deps: SeasonAiGenerationDeps, ids: string[], commandIdPrefix: string): {
    state: SeasonDraftState;
...
function customCatalog(entries: Array<{
    ...
    for (const entry of entries) {
        ...
        for (let i = 0; i < 12; i += 1) {
            ...
            candidate.positions.secondary = playable.slice(1) as SeasonDraftCandidate['positions']['secondary'];
