import { SEASON_SEED_NAMESPACES, seasonNamespaceSeed, type SeasonLeague, type SeasonStandings, type SeasonStandingsRow, type SeasonTiebreakResolution, type SeasonTiebreakRule, } from '@hoop-rush/data-contracts';
