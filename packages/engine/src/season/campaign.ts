import { SEASON_CAMPAIGN_TARGETS_VERSION, SEASON_CAMPAIGN_VERSION, SEASON_INFLUENCE_CAP, SEASON_INFLUENCE_FLOOR, blockRoundRange, buildEmptyCampaignState, commandIdSchema, franchiseIdSchema, idSchema, seasonCampaignStateSchema, seasonNamespaceSeed, type SeasonCampaignCondition, type SeasonCampaignEvaluation, type SeasonCampaignEvolutionOffer, type SeasonCampaignFamily, type SeasonCampaignFocus, type SeasonCampaignGmIdentity, type SeasonCampaignOpportunity, type SeasonCampaignReward, type SeasonCampaignState, type SeasonGameSummary, type SeasonHealthState, type SeasonInfluenceState, type SeasonRoster, type SeasonRotation, type SeasonSchedule, type SeasonStandings, type SeasonTransactionEntry, } from '@hoop-rush/data-contracts';
...
function opportunityId(seedRoot: string, blockIndex: number, slot: number, templateId: string): string {
    return hexId('copp', seasonNamespaceSeed(seedRoot, 'campaign', String(blockIndex), 'offers', String(slot), templateId));
}
const CAMPAIGN_TEMPLATES: readonly CampaignTemplate[] = [
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'results-block-wins-6')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'results-winning-block')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'results-a')),
        family: 'results',
        identity: 'win-now',
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'results-top-six')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'results-play-in')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'results-b')),
        family: 'results',
        identity: 'win-now',
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'marquee-win-over-higher')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'marquee-beat-leader')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'marquee-a')),
        family: 'marquee',
        identity: 'win-now',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'marquee-sweep')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'marquee-sweep-2')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'marquee-b')),
        family: 'marquee',
        identity: 'win-now',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-defensive')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-three')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'style-a')),
        family: 'style',
        identity: 'team-identity',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-assists')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-turnover')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'style-b')),
        family: 'style',
        identity: 'team-identity',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-rebound')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'style-bench')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'style-c')),
        family: 'style',
        identity: 'team-identity',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'player-minutes')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'player-points')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'player-a')),
        family: 'player-role',
        identity: 'player-development',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'player-availability')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'player-rebounds')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'player-b')),
        family: 'player-role',
        identity: 'player-development',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'roster-new-minutes')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'roster-replace')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'roster-a')),
        family: 'roster-response',
        identity: 'team-identity',
        target: {
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'roster-depth')),
    ...
    {
        templateId: hexId('ctpl', seasonNamespaceSeed('campaign-catalog-v1', 'template', 'roster-depth-2')),
        branchId: hexId('cbr', seasonNamespaceSeed('campaign-catalog-v1', 'branch', 'roster-b')),
        family: 'roster-response',
        identity: 'team-identity',
        target: {
...
function resolvePlayerForTemplate(template: CampaignTemplate, input: SeasonCampaignGenerationInput): {
    playerVersionId: string | null;
    feasible: boolean;
    ...
    const candidates = roster.players
        ...
        .filter((p) => rotation.targetMinutes.some((tm) => tm.playerVersionId === p.playerVersionId && tm.minutes > 0) || rotation.starters.includes(p.playerVersionId))
    ...
    const seed = seasonNamespaceSeed(input.rootSeed, 'campaign', String(input.blockIndex), 'offers', 'candidate', template.templateId);
...
function scheduleFactsForTemplate(template: CampaignTemplate, input: SeasonCampaignGenerationInput): {
    opponentFranchiseId: string | null;
    feasible: boolean;
    facts: Record<string, unknown>;
    audit: string | null;
    ...
    const humanGames = blockGames.filter((g) => g.homeFranchiseId === humanFranchiseId || g.awayFranchiseId === humanFranchiseId);
    ...
    const opponents = [
        ...new Set(humanGames.map((g) => g.homeFranchiseId === humanFranchiseId ? g.awayFranchiseId : g.homeFranchiseId)),
    ].sort();
    const targetOpponent = 'opponentFranchiseId' in template.target ? template.target.opponentFranchiseId : undefined;
    const breakthroughOpponent = template.breakthrough !== null && 'opponentFranchiseId' in template.breakthrough
        ? template.breakthrough.opponentFranchiseId
        : undefined;
    const templateOpponent = targetOpponent ?? breakthroughOpponent;
        ...
        return {
            ...
            facts: {
                ...
                scheduleGameIds: humanGames
                    .filter((g) => g.homeFranchiseId === templateOpponent || g.awayFranchiseId === templateOpponent)
                    .map((g) => g.gameId),
    ...
    const seed = seasonNamespaceSeed(input.rootSeed, 'campaign', String(input.blockIndex), 'offers', 'candidate', template.templateId, 'opponent');
    const rng = createRng(seed);
...
function transactionFactsForTemplate(template: CampaignTemplate, input: SeasonCampaignGenerationInput): {
    feasible: boolean;
    facts: Record<string, unknown>;
    audit: string | null;
} {
    if (template.requires !== 'transaction')
        return { feasible: true, facts: {}, audit: null };
    const humanFranchiseId = input.humanFranchiseId;
    if (humanFranchiseId === null) {
        return { feasible: false, facts: {}, audit: 'transaction template requires human franchise' };
    }
    const relevant = input.transactions.filter((t) => t.franchiseId === humanFranchiseId &&
    ...
    if (relevant.length > 0) {
        ...
        const seed = seasonNamespaceSeed(input.rootSeed, 'campaign', String(input.blockIndex), 'offers', 'candidate', template.templateId, 'txn');
        const rng = createRng(seed);
...
function isBranchOpen(template: CampaignTemplate, campaignState: SeasonCampaignState): {
    open: boolean;
    ...
    if (!prev)
        return { open: false, prerequisiteId: null, audit: 'no previous in branch' };
    const state = campaignState.branchState[template.branchId];
    if (state === 'missed' || state === 'locked') {
        return {
            open: false,
...
function weightForCandidate(template: CampaignTemplate, input: SeasonCampaignGenerationInput, isFollowUp: boolean): number {
    let weight = 1;
    ...
    if (identity !== null && template.identity === identity)
        weight += 1.5;
    if (famFocus !== null && template.family === famFocus)
        weight += 1;
    if (isFollowUp)
        weight += 2;
    return weight;
...
export function generateSeasonCampaignOffers(input: SeasonCampaignGenerationInput): SeasonCampaignOpportunity[] {
    if (input.blockIndex < 0 || input.blockIndex > 7) {
        throw new SeasonCampaignGenerationError(`blockIndex ${String(input.blockIndex)} has no campaign opportunity (blocks 0-7 only, block 8 no opportunity)`, input.blockIndex, [`block ${String(input.blockIndex)} out of range`]);
    }
    if (input.humanFranchiseId === null) {
        throw new SeasonCampaignGenerationError('human franchise required for campaign', input.blockIndex, ['no human franchise']);
    }
    ...
    if (feasible.length < 2) {
        throw new SeasonCampaignGenerationError(`not enough feasible campaign candidates for block ${String(input.blockIndex)} (found ${String(feasible.length)}, need 2)`, input.blockIndex, auditDropped);
    }
    ...
    for (let slot = 0; slot < 2; slot += 1) {
        const seed = seasonNamespaceSeed(input.rootSeed, 'campaign', String(input.blockIndex), 'offers', String(slot));
        const rng = createRng(seed);
        const items = remaining.map((r) => r.candidate);
        const weights = remaining.map((r) => r.weight);
        const pick = rng.weightedPick(items, weights);
        const pickIdx = remaining.findIndex((r) => r.candidate.template.templateId === pick.template.templateId &&
    ...
    if (opportunities[0]?.opportunityId === opportunities[1]?.opportunityId) {
        throw new SeasonCampaignGenerationError('generated duplicate opportunity ids', input.blockIndex, auditDropped);
    }
...
function evaluateCondition(condition: SeasonCampaignCondition, input: SeasonCampaignEvaluationInput): {
    met: boolean;
    factValue: number;
    facts: Record<string, unknown>;
} {
    ...
    const humanWins = summaries.filter((s) => {
        if (s.status === 'forfeit')
            return s.forfeitLoserFranchiseId !== human;
    ...
    switch (condition.kind) {
        ...
        case 'top-six': {
            if (human === null)
                return { met: false, factValue: 99, facts: { position: 99 } };
        ...
        case 'play-in': {
            if (human === null)
                return { met: false, factValue: 99, facts: {} };
            const order = [...input.standings.rows]
                .sort((a, b) => b.wins - a.wins ||
                b.pointsFor - b.pointsAgainst - (a.pointsFor - a.pointsAgainst) ||
                (a.franchiseId < b.franchiseId ? -1 : 1))
            ...
            const metPlayIn = compare(inPlayIn ? 1 : 0, condition.comparisonOperator, condition.threshold);
        ...
        case 'beat-conference-leader': {
            const opponentId = condition.opponentFranchiseId;
        ...
        case 'sweep-opponent': {
            const opponentId = condition.opponentFranchiseId;
            const gamesVsOpp = summaries.filter((s) => s.homeFranchiseId === opponentId || s.awayFranchiseId === opponentId);
            ...
            const met = condition.comparisonOperator === 'gte'
                ? isSweep
        ...
        case 'bench-contribution': {
            ...
            for (const s of summaries) {
                ...
                for (const line of lines) {
                    if (!starters.has(line.playerVersionId))
                        benchPoints += line.points;
                }
            }
            if (benchPoints === 0 && summaries.length > 0) {
                benchPoints = summaries.reduce((sum, s) => sum + (s.homeFranchiseId === human ? s.homeBox.points : s.awayBox.points), 0);
            }
        ...
        case 'player-minutes': {
            const pid = condition.playerVersionId;
            let seconds = 0;
            for (const s of summaries) {
                const lines = s.homeFranchiseId === human ? s.homePlayers : s.awayPlayers;
        ...
        case 'player-availability': {
            ...
            for (const s of summaries) {
                ...
                if (line && line.seconds > 0)
                    avail += 1;
                else if (seasonPlayerAvailable(input.health, pid))
                    avail += 1;
            }
            if (summaries.length === 0)
                avail = seasonPlayerAvailable(input.health, pid) ? 10 : 0;
        ...
        case 'roster-new-player-minutes': {
            ...
            for (const t of input.transactions) {
                if (t.type === 'trade' || t.type === 'free-agent-signing') {
                    ...
                    const rawIncoming: unknown = payload['incomingPlayerVersionIds'];
                    const rawSingle: unknown = payload['playerVersionId'];
                    const added: string[] = Array.isArray(rawIncoming)
                        ? rawIncoming.filter((id): id is string => typeof id === 'string')
                        : typeof rawSingle === 'string'
                            ? [rawSingle]
                            : [];
            ...
            for (const s of summaries) {
                ...
                for (const id of targetIds) {
                    ...
                    if (line)
                        minutes += Math.floor(line.seconds / 60);
                }
            }
            const met = compare(minutes, condition.comparisonOperator, condition.threshold);
        ...
        case 'roster-new-player-starts': {
            ...
            for (const t of input.transactions) {
                if (t.type === 'trade' || t.type === 'free-agent-signing') {
                    const payload = t.payload;
                    const rawAdded: unknown = payload['incomingPlayerVersionIds'];
                    const added: string[] = Array.isArray(rawAdded)
        ...
        case 'roster-replace-unavailable': {
            ...
            for (const s of summaries) {
                ...
                for (const id of newIds) {
                    const line = lines.find((l) => l.playerVersionId === id);
                    if (line)
                        replacedMinutes += Math.floor(line.seconds / 60);
                }
            }
            const met = unavailable.length > 0 &&
                replacedMinutes > 0 &&
        ...
        default: {
            ...
            return assertNever(exhaustive, `unknown campaign condition kind`);
        }
    }
}
export function evaluateSeasonCampaignOpportunity(input: SeasonCampaignEvaluationInput): SeasonCampaignEvaluation {
    const { opportunity } = input;
    if (input.blockIndex < 0 || input.blockIndex > 7) {
        throw new SeasonCampaignEvaluationError(`blockIndex ${String(input.blockIndex)} out of range for evaluation`);
    }
    if (opportunity.blockIndex !== input.blockIndex) {
        throw new SeasonCampaignEvaluationError(`opportunity block ${String(opportunity.blockIndex)} mismatches evaluation block ${String(input.blockIndex)}`);
    }
    const breakthrough = opportunity.breakthrough;
    const targetRes = evaluateCondition(opportunity.target, input);
    const breakthroughRes = breakthrough ? evaluateCondition(breakthrough, input) : null;
    ...
    const facts: Record<string, unknown> = {
        ...
        breakthrough: breakthrough !== null && breakthroughRes !== null
            ? {
                kind: breakthrough.kind,
                threshold: breakthrough.threshold,
    ...
    const explanation = outcome === 'breakthrough'
...
function applyInfluenceReward(influence: SeasonInfluenceState, franchiseId: string, requestedDelta: number, blockIndex: number, commandId: string | null, explanation: string, rewardId: string): {
    influence: SeasonInfluenceState;
    ...
    const entry = {
        entryId: idSchema.parse(deriveSeasonInfluenceEntryId(`influence-campaign-${String(blockIndex)}-${franchiseId}-${rewardId}`)),
        franchiseId: fid,
...
export function applySeasonCampaignReward(input: SeasonCampaignRewardApplicationInput): SeasonCampaignRewardApplicationResult {
    ...
    for (const reward of rewardsToApply) {
        if (appliedRewardIds.includes(reward.rewardId))
            continue;
        ...
        switch (reward.type) {
            case 'influence': {
                ...
                const res = applyInfluenceReward(influence, humanFranchiseId, requested, blockIndex, input.commandId ?? null, `Campaign reward ${reward.rewardId} (+${String(requested)} Influence)`, reward.rewardId);
...
export function generateSeasonCampaignEvolutionOffers(input: SeasonCampaignEvolutionGenerationInput): SeasonCampaignEvolutionOffer[] {
    ...
    const identity = effectiveIdentity(input.campaignState);
    if (identity === null) {
        throw new SeasonCampaignGenerationError('evolution requires starting identity', input.blockIndex, ['no starting identity']);
    }
    ...
    const hasNewPlayer = input.transactions.some((t) => t.type === 'trade' || t.type === 'free-agent-signing');
    ...
    if (offers.length < 3) {
        const pivotIdentities: SeasonCampaignGmIdentity[] = (['win-now', 'player-development', 'team-identity'] as const).filter((id) => id !== identity);
        const seed = seasonNamespaceSeed(input.rootSeed, 'campaign', 'evolution', 'pivot');
        const rng = createRng(seed);
        const pivotIdentity = rng.pick(pivotIdentities);
        const pivotSeed = seasonNamespaceSeed(input.rootSeed, 'campaign', 'evolution', 'pivot', pivotIdentity);
        const focusForPivot: SeasonCampaignFocus | null = pivotIdentity === 'team-identity' ? 'ball-movement' : null;
        offers.push({
    ...
    canonical.sort((a, b) => {
        if (a.kind === 'double-down' && b.kind !== 'double-down')
            return -1;
        if (b.kind === 'double-down' && a.kind !== 'double-down')
            return 1;
        if (a.kind !== b.kind)
...
export function applySeasonCampaignEvolutionSelection(input: SeasonCampaignEvolutionSelectionInput): SeasonCampaignState {
    if (input.campaignState.evolutionOffers === null) {
...
export function auditCampaignOpportunity(opportunity: SeasonCampaignOpportunity): string[] {
    ...
    if (opportunity.seedPath[0] !== 'campaign')
        failures.push('seedPath must start with campaign');
