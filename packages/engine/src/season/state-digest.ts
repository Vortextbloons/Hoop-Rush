...
function postseasonCanonical(postseason: SeasonPostseasonState): unknown {
    return {
        ...
        tiebreakResolutions: sortedBy(postseason.tiebreakResolutions, (resolution) => resolution.resolutionId),
...
export function seasonRunStateDigest(facts: SeasonRunStateDigestFacts): string {
    const canonical = canonicalJson({
        ...
        influence: {
            ...
            windows: Object.fromEntries(Object.entries(facts.influence.windows)
                .sort(([a], [b]) => (a < b ? -1 : 1))
                .map(([franchiseId, windows]) => [
                franchiseId,
                [...windows].sort((a, b) => a.windowIndex - b.windowIndex),
            ])),
            rehabs: Object.fromEntries(Object.entries(facts.influence.rehabs).sort(([a], [b]) => (a < b ? -1 : 1))),
        },
        ...
        ...(facts.campaign !== undefined && facts.campaign !== null
            ? {
                campaign: {
                    ...
                    offers: Object.fromEntries(Object.entries(facts.campaign.offers)
                        .sort(([a], [b]) => Number(a) - Number(b))
                        .map(([blockIndex, offers]) => [
                        blockIndex,
                        sortedBy(offers as import('@hoop-rush/data-contracts').SeasonCampaignOpportunity[], (o) => o.opportunityId),
                    ])),
                    selections: Object.fromEntries(Object.entries(facts.campaign.selections).sort(([a], [b]) => Number(a) - Number(b))),
        ...
        authority: authorityCanonical((facts.authority as SeasonRunAuthority | undefined) ??
            ({
                kind: 'local-solo',
