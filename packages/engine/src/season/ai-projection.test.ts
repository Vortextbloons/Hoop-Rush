...
import { seasonLeagueGenerationResultSchema, RATINGS_VERSION, type ProjectionModelArtifact, type SimulationPlayer, } from '@hoop-rush/data-contracts';
...
function tinyModel(): ProjectionModelArtifact {
    ...
    return {
        ...
        search: {
            ...
            singleRemovals: 'all',
            pairRemovals: 1,
            nodeBudgets: { partial: 2000, complete: 2000, rotation: 8 },
...
describe('AI projection shadow mode', () => {
    it('records compact summaries without changing selection or the digest', () => {
        ...
        const aiEvaluations = projected.evaluations.filter((evaluation) => evaluation.franchiseId !== 'lakers');
    ...
    it('keeps pools, anchors, and legality intact under projection', () => {
        ...
        const humanVersions = new Set(projected.rosters
