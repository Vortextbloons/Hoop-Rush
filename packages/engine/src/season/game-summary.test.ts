...
import { SEASON_MINUTE_POLICY_VERSION, SEASON_NEUTRAL_HOME_COURT, SEASON_ROTATION_VERSION, franchiseIdSchema, playerIdSchema, playerVersionId, seasonGameIdSchema, seasonGameSummarySchema, seasonRetainedGameDetailSchema, seedSchema, type Position, type SeasonGameSimulationInput, type SeasonGameTeamInput, type SeasonRotation, type SeasonScheduleGame, } from '@hoop-rush/data-contracts';
...
describe('season game summaries (M2.3)', () => {
    ...
    it('throws for the no-legal-five-both outcome', () => {
        ...
        expect(() => seasonGameSummaryFromResult(result, scheduleGameOf(input))).toThrow(/no-legal-five-both/);
    });
