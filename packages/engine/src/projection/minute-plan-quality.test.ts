...
import type { BaseFiveProjectionInput, EraId, ProjectionModelArtifact, SimulationPlayer, } from '@hoop-rush/data-contracts';
...
function smallModel(): ProjectionModelArtifact {
    const referencePlayers = () => [1, 2, 3, 4, 5].map((n) => ({
