...
export function identifyWeaknesses(model: ProjectionModelArtifact, values: WeaknessComponentValues): ProjectionWeakness[] {
...
export function weaknessPenalty(model: ProjectionModelArtifact, weaknesses: readonly ProjectionWeakness[]): number {
