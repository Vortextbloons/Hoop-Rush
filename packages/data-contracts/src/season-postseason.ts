...
export function buildInitialPostseasonState(rootSeed: z.infer<typeof seedSchema>): SeasonPostseasonState {
    ...
    return {
        ...
        seed,
        finalsHomeCourtDrawSeed: seasonNamespaceSeed(seed, SEASON_SEED_NAMESPACES.postseasonDraws, 'finals-home-court'),
        tiebreakResolutions: [],
