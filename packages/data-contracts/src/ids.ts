...
export const idSchema = baseIdSchema.brand<'Id'>();
export type Id = z.infer<typeof idSchema>;
export const commandIdSchema = baseIdSchema.brand<'CommandId'>();
...
export const playerIdSchema = baseIdSchema.brand<'PlayerId'>();
export type PlayerId = z.infer<typeof playerIdSchema>;
export const franchiseIdSchema = baseIdSchema.brand<'FranchiseId'>();
export type FranchiseId = z.infer<typeof franchiseIdSchema>;
export const eraIdSchema = baseIdSchema.brand<'EraId'>();
