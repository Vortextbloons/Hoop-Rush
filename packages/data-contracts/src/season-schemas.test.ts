...
describe('season schedule schema', () => {
    ...
    it('rejects malformed game records', () => {
        ...
        expect(() => seasonScheduleSchema.parse({
            ...schedule,
