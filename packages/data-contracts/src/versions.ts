...
export const DERIVATION_METHOD_VERSION = 'derive-v13';
export const RATINGS_VERSION = 'ratings-v3.12';
export const SELECTION_SCORE_VERSION = 'selection-v3.14-ratings-v3.12';
export const RATING_MODEL_VERSION = 'ratings-model-v3.6';
export const THREE_POINT_RECONSTRUCTION_VERSION = 'three-point-reconstruction-v1';
export const COHORT_NORMALIZATION_VERSION = 'overall-cohort-v7';
export const POOL_SCHEMA_VERSION = 5;
export const PLAYERS_INDEX_SCHEMA_VERSION = 5;
export const POSITION_NORMALIZATION_VERSION = 'position-v4';
export const POSITION_OVERRIDES_VERSION = 'position-overrides-v2';
