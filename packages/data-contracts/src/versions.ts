...
export const DERIVATION_METHOD_VERSION = 'derive-v10';
export const RATINGS_VERSION = 'ratings-v3.9';
export const SELECTION_SCORE_VERSION = 'selection-v3.9-ratings-v3.9';
...
export const COHORT_NORMALIZATION_VERSION = 'overall-cohort-v3';
