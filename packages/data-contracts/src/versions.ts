...
export const DERIVATION_METHOD_VERSION = 'derive-v12';
export const RATINGS_VERSION = 'ratings-v3.11';
export const SELECTION_SCORE_VERSION = 'selection-v3.11-ratings-v3.11';
export const RATING_MODEL_VERSION = 'ratings-model-v3.5';
export const THREE_POINT_RECONSTRUCTION_VERSION = 'three-point-reconstruction-v1';
export const COHORT_NORMALIZATION_VERSION = 'overall-cohort-v6';
