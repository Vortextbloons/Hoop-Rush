...
export const DERIVATION_METHOD_VERSION = 'derive-v9';
export const RATINGS_VERSION = 'ratings-v3.8';
export const SELECTION_SCORE_VERSION = 'selection-v3.8-ratings-v3.8';
...
export const COHORT_NORMALIZATION_VERSION = 'overall-cohort-v2';
