...
export const reconstructionFeatureNormalizationSchema = z.record(z.string().min(1).max(64), z.object({
    mean: z.number(),
...
export const reconstructionMetricsSchema = z.object({
    ...
    evidenceBands: z.array(z.object({
...
export type ThreePointReconstructionArtifact = z.infer<typeof threePointReconstructionArtifactSchema>;
