...
export const seasonObjectivePerFranchiseSelectionSchema = z.record(z.string().min(1).max(64), z.record(z.coerce.number().int().min(0).max(7), seasonObjectiveSelectionSchema));
export type SeasonObjectivePerFranchiseSelection = z.infer<typeof seasonObjectivePerFranchiseSelectionSchema>;
