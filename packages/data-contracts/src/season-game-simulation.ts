...
import { simulationAnchorsSchema, simulationRatingsSchema, simulationTendenciesSchema, } from './simulation.ts';
...
import { SEASON_GAME_TARGETS_VERSION, SEASON_GAME_VERSION, SEASON_ROTATION_PLANNER_VERSION, SEASON_ROTATION_V2, SEASON_ROTATION_VERSION, } from './season-versions.ts';
...
} as const satisfies Record<SeasonRotationPreset, {
    starters: number;
    bench: readonly [
        number,
        number,
