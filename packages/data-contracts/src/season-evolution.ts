...
export const SEASON_FRONT_OFFICE_CATALOG: readonly SeasonFrontOfficeCatalogEntry[] = [
  {
    ...
    ability: 'Four base Trade Board inquiries per window instead of three.',
    drawback: 'Risky rehabilitation costs one additional Influence.',
  ...
  },
  {
    ...
    version: SEASON_FRONT_OFFICE_VERSION,
    ability: 'Risky rehabilitation costs one less Influence, minimum one.',
    drawback: 'Purchased Trade Board inquiries cost two Influence instead of one.',
  ...
  },
  {
    ...
    version: SEASON_FRONT_OFFICE_VERSION,
    ability:
      'Each successful Campaign opportunity granting Influence grants one additional Influence.',
    drawback: 'Risky rehabilitation costs one additional Influence.',
    baseInquiryAllowance: 3,
    purchasedInquiryCost: 1,
    rehabDelta: 1,
