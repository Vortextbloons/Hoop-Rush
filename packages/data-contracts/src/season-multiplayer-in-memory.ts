import { SEASON_MULTIPLAYER_VERSION, SEASON_MULTIPLAYER_VERSION_V1, SEASON_ROOM_PROTOCOL_SCHEMA_VERSION, SEASON_ROOM_PROTOCOL_SCHEMA_VERSION_V1, SEASON_TIMER_POLICY_VERSION, } from './season-versions.ts';
...
export class InMemorySeasonMultiplayerTransport implements SeasonMultiplayerTransport {
    ...
    async _updateSettingsAsGuest(roomId: string, settings: {
        mode: SeasonRoomMode;
        pace: SeasonRoomPace;
