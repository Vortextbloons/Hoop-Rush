...
export const archetypeMembershipsSchema = z
    ...
    .strict()
    .refine((memberships) => Math.abs(Object.values(memberships).reduce((sum, value) => sum + value, 0) - 1) < 0.00001, 'archetype memberships must sum to one');
...
export const ratingsModelArtifactSchema = z.object({
    ...
    regressionGates: z.array(z.object({
