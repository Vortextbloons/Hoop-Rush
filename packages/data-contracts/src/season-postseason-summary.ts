...
import { playInMatchupIdSchema, playoffRoundSchema, postseasonGameIdSchema, type PlayInMatchupId, type PlayoffRound, } from './season-postseason.ts';
...
export type SeasonPostseasonRotationEvidence = z.infer<typeof seasonPostseasonRotationEvidenceSchema>;
...
export const seasonPostseasonSummarySchema = z
    ...
    if (summary.status === 'forfeit') {
        ...
        if ((homeWon && summary.winnerFranchiseId !== summary.homeFranchiseId) ||
