...
import { eraIdSchema, franchiseIdSchema, franchiseLineageEntrySchema, seasonKeySchema, } from './index.ts';
...
function segment(modernFranchiseId: string, displayName: string, abbreviation: string, from: string, to?: string, logos = [cdn('1610610000')]): FranchiseLineageEntry {
