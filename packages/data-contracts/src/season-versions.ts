...
export const SEASON_DRAFT_SCRIPT_VERSION = 'draft-script-v2';
export const SEASON_DRAFT_SCRIPT_STAR_COUNT = 1;
export const SEASON_DRAFT_SCRIPT_FLOOR_COUNT = 2;
export const SEASON_DRAFT_SCRIPT_STAR_MIN_OVERALL = 85;
export const SEASON_DRAFT_SCRIPT_FLOOR_MAX_OVERALL = 80;
