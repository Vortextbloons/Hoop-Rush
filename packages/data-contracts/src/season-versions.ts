export const SEASON_RUN_SCHEMA_VERSION = 14;
export const SEASON_RUN_SCHEMA_VERSION_V13 = 13;
export const SEASON_RUN_SCHEMA_VERSION_V12 = 12;
export const SEASON_RUN_SCHEMA_VERSION_V11 = 11;
export const SEASON_DRAFT_SAVE_SCHEMA_VERSION = 4;
export const SEASON_DRAFT_SAVE_SCHEMA_VERSION_V3 = 3;
export const SEASON_RUN_SAVE_SCHEMA_VERSION = 12;
export const SEASON_RUN_SAVE_SCHEMA_VERSION_V11 = 11;
...
export const SEASON_COMMAND_LOG_VERSION = 'command-log-v3';
export const SEASON_COMMAND_LOG_VERSION_V2 = 'command-log-v2';
export const SEASON_COMMAND_LOG_VERSION_V1 = 'command-log-v1';
export const SEASON_ALMANAC_VERSION = 'almanac-v2';
export const SEASON_REPLAY_EXPORT_VERSION = 'replay-export-v3';
export const SEASON_REPLAY_EXPORT_VERSION_V2 = 'replay-export-v2';
export const SEASON_REPLAY_EXPORT_VERSION_V1 = 'replay-export-v1';
...
export const SEASON_DRAFT_VERSION = 'season-draft-v4';
export const SEASON_DRAFT_VERSION_V3 = 'season-draft-v3';
export const SEASON_DRAFT_VERSION_V2 = 'season-draft-v2';
...
export const SEASON_OFFER_TARGETS_VERSION = 'offer-targets-v2';
export const SEASON_OFFER_TARGETS_VERSION_V1 = 'offer-targets-v1';
export const SEASON_DRAFT_SCRIPT_VERSION = 'draft-script-v1';
export const SEASON_DRAFT_SCRIPT_STAR_COUNT = 2;
export const SEASON_DRAFT_SCRIPT_FLOOR_COUNT = 3;
export const SEASON_DRAFT_SCRIPT_STAR_MIN_OVERALL = 85;
export const SEASON_DRAFT_SCRIPT_FLOOR_MAX_OVERALL = 79;
export const SEASON_ROSTER_RULES_VERSION = 'season-roster-v3';
export const SEASON_ROSTER_RULES_VERSION_V2 = 'season-roster-v2';
export const SEASON_FREE_AGENCY_VERSION = 'season-free-agency-v3';
export const SEASON_FREE_AGENCY_VERSION_V2 = 'season-free-agency-v2';
export const SEASON_FREE_AGENCY_VERSION_V1 = 'season-free-agency-v1';
export const SEASON_FREE_AGENCY_INDEX_VERSION = 'free-agency-index-v2';
export const SEASON_FREE_AGENCY_INDEX_VERSION_V1 = 'free-agency-index-v1';
export const SEASON_FREE_AGENCY_TARGETS_VERSION = 'free-agency-targets-v2';
export const SEASON_FREE_AGENCY_TARGETS_VERSION_V1 = 'free-agency-targets-v1';
export const SEASON_ROSTER_GENERATION_V2 = 'roster-generation-v2';
export const SEASON_ROSTER_GENERATION_VERSION_V3 = 'roster-generation-v3';
export const SEASON_ROSTER_GENERATION_VERSION_V4 = 'roster-generation-v4';
export const SEASON_ROSTER_GENERATION_VERSION = 'roster-generation-v5';
export const SEASON_AI_V2 = 'season-ai-v2';
export const SEASON_AI_VERSION_V3 = 'season-ai-v3';
export const SEASON_AI_VERSION_V4 = 'season-ai-v4';
export const SEASON_AI_VERSION = 'season-ai-v5';
...
export const SEASON_ROSTER_TARGETS_VERSION_V3 = 'roster-targets-v3';
export const SEASON_ROSTER_TARGETS_VERSION = 'roster-targets-v4';
export const SEASON_BLOCK_VERSION = 'season-block-v7';
export const SEASON_BLOCK_VERSION_V6 = 'season-block-v6';
export const SEASON_BLOCK_VERSION_V5 = 'season-block-v5';
...
export const SEASON_RECAP_VERSION = 'season-recap-v6';
export const SEASON_RECAP_VERSION_V5 = 'season-recap-v5';
export const SEASON_LEADERS_VERSION = 'season-leaders-v1';
export const SEASON_HOME_COURT_VERSION = 'season-home-court-v1';
export const SEASON_CHECKPOINT_VERSION = 'season-checkpoint-v7';
export const SEASON_CHECKPOINT_VERSION_V6 = 'season-checkpoint-v6';
export const SEASON_CHECKPOINT_VERSION_V5 = 'season-checkpoint-v5';
...
export const SEASON_TRADE_VERSION_V6 = 'season-trade-v6';
export const SEASON_TRADE_VERSION_V5 = 'season-trade-v5';
...
export const SEASON_OBJECTIVE_VERSION = 'season-objective-v3';
export const SEASON_OBJECTIVE_VERSION_V2 = 'season-objective-v2';
export const SEASON_OBJECTIVE_VERSION_V1 = 'season-objective-v1';
export const SEASON_CHALLENGE_VERSION = 'season-challenge-v3';
export const SEASON_CHALLENGE_VERSION_V2 = 'season-challenge-v2';
export const SEASON_CHALLENGE_VERSION_V1 = 'season-challenge-v1';
export const SEASON_CHALLENGE_TARGETS_VERSION = 'challenge-targets-v1';
export const SEASON_CAMPAIGN_VERSION = 'season-campaign-v3';
export const SEASON_CAMPAIGN_VERSION_V2 = 'season-campaign-v2';
export const SEASON_CAMPAIGN_VERSION_V1 = 'season-campaign-v1';
...
export const SEASON_INFLUENCE_TARGETS_VERSION = 'influence-targets-v3';
export const SEASON_INFLUENCE_TARGETS_VERSION_V2 = 'influence-targets-v2';
export const SEASON_INFLUENCE_TARGETS_VERSION_V1 = 'influence-targets-v1';
