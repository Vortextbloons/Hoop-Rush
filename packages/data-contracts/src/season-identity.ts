...
export function playerVersionId(playerId: string, franchiseId: string, eraId: string, seasonKey: string): PlayerVersionId {
    return `pv-${seasonDigestHex(`${PLAYER_VERSION_ID_VERSION}\u0000${playerId}\u0000${franchiseId}\u0000${eraId}\u0000${seasonKey}`)}`;
}
