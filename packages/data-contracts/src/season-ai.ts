...
import { SEASON_AI_V2, SEASON_AI_VERSION, SEASON_MINUTE_POLICY_VERSION, SEASON_ROSTER_GENERATION_V2, SEASON_ROSTER_GENERATION_VERSION, SEASON_ROSTER_TARGETS_V2, SEASON_ROSTER_TARGETS_VERSION, SEASON_ROTATION_VERSION, } from './season-versions.ts';
