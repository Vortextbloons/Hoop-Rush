import { z } from 'zod';
import { commandIdSchema, contentHashSchema, franchiseIdSchema, idSchema, seasonGameIdSchema, seedSchema, } from './ids.ts';
import { seasonCandidateCheckpointSchema, seasonCheckpointDigestSchema, } from './season-checkpoint.ts';
