...
export function loadManifest(url: string, expectedHash?: string, init?: RequestInit): Promise<HoopRushManifest>;
export function loadManifest(url: string, init?: RequestInit): Promise<HoopRushManifest>;
export function loadManifest(url: string, expectedHashOrInit?: string | RequestInit, init?: RequestInit): Promise<HoopRushManifest> {
