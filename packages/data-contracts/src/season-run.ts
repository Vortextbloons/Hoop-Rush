...
import { PLAYER_VERSION_ID_VERSION, SEASON_AI_V2, SEASON_AI_VERSION, SEASON_AGGREGATES_VERSION, SEASON_ALMANAC_VERSION, SEASON_AUTHORITY_VERSION, SEASON_AWARDS_VERSION, SEASON_BLOCK_VERSION, SEASON_CHECKPOINT_VERSION, SEASON_CHEMISTRY_VERSION, SEASON_COMMAND_LOG_VERSION, SEASON_DRAFT_LEGACY_VERSION, SEASON_DRAFT_VERSION, SEASON_EFFECT_TARGETS_LEGACY_VERSION, SEASON_EFFECT_TARGETS_VERSION, SEASON_FREE_AGENCY_INDEX_VERSION, SEASON_FREE_AGENCY_TARGETS_VERSION, SEASON_FREE_AGENCY_VERSION, SEASON_GAME_COUNT, SEASON_GAME_SUMMARY_VERSION, SEASON_GAME_TARGETS_VERSION, SEASON_GAME_VERSION, SEASON_HEALTH_VERSION, SEASON_CAMPAIGN_TARGETS_VERSION, SEASON_CAMPAIGN_VERSION, SEASON_HOME_COURT_VERSION, SEASON_INFLUENCE_TARGETS_VERSION, SEASON_INFLUENCE_VERSION, SEASON_INJURY_TARGETS_VERSION, SEASON_LEAGUE_VERSION, SEASON_LEADERS_VERSION, SEASON_MINUTE_POLICY_VERSION, SEASON_OBJECTIVE_VERSION, SEASON_POSTSEASON_SUMMARY_VERSION, SEASON_POSTSEASON_TARGETS_VERSION, SEASON_POSTSEASON_VERSION, SEASON_RECAP_VERSION, SEASON_REPLAY_EXPORT_VERSION, SEASON_ROSTER_GENERATION_V2, SEASON_ROSTER_GENERATION_VERSION, SEASON_ROSTER_RULES_VERSION, SEASON_ROSTER_TARGETS_V2, SEASON_ROSTER_TARGETS_VERSION, SEASON_DRAFT_SIZE, SEASON_ROTATION_PLANNER_VERSION, SEASON_ROTATION_VERSION, SEASON_RUN_SCHEMA_VERSION, SEASON_SCHEDULE_FORMULA_VERSION, SEASON_SCHEDULE_VERSION, SEASON_SEED_DERIVATION_VERSION, SEASON_STAMINA_LEGACY_VERSION, SEASON_STAMINA_VERSION, SEASON_STANDINGS_VERSION, SEASON_TEAM_COUNT, SEASON_TIEBREAK_VERSION, SEASON_TRADE_GRADE_VERSION, SEASON_TRADE_TARGETS_VERSION, SEASON_TRADE_VERSION, } from './season-versions.ts';
...
import { seasonAiAssignmentSchema, seasonAiPoolSchema, seasonGenerationDiagnosticsSchema, seasonRosterEvaluationSchema, } from './season-ai.ts';
import { seasonRotationSchema } from './season-rotation.ts';
export { seasonRosterEntrySchema, seasonRosterSchema, seasonOwnershipSchema, } from './season-roster.ts';
...
export const seasonRunVersionsSchema = z.object({
    runSchemaVersion: z.union([z.literal(SEASON_RUN_SCHEMA_VERSION), z.literal(12), z.literal(11)]),
    ...
    checkpointVersion: z.union([
        ...
        z.literal('season-checkpoint-v5'),
    ]),
    ...
    campaignVersion: z
        .union([z.literal(SEASON_CAMPAIGN_VERSION), z.literal('season-campaign-v1')])
        .optional(),
