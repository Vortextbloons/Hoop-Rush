...
export const seasonRunVersionsSchema = z.object({
    runSchemaVersion: z.union([z.literal(SEASON_RUN_SCHEMA_VERSION), z.literal(11)]),
...
export const seasonRunSchema = z
    ...
    authority: seasonRunAuthoritySchema.optional(),
