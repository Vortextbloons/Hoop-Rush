...
export function buildSeasonRosters(league: SeasonLeague, seed: string): SeasonRoster[] {
    ...
    return league.teams.map((team, teamIndex) => seasonRosterSchema.parse({
        franchiseId: team.franchiseId,
