import { SEASON_MULTIPLAYER_VERSION, SEASON_MULTIPLAYER_VERSION_V1, SEASON_ROOM_PROTOCOL_SCHEMA_VERSION, SEASON_ROOM_PROTOCOL_SCHEMA_VERSION_V1, SEASON_TIMER_POLICY_VERSION, } from '@hoop-rush/data-contracts';
...
export class InMemorySeasonMultiplayerTransport implements SeasonMultiplayerTransport {
    ...
    private isOutdatedRoom(room: InMemoryRoom): boolean {
        return (room.settings.multiplayerVersion !== SEASON_MULTIPLAYER_VERSION ||
    ...
    async _updateSettingsAsGuest(roomId: string, _settings: {
        mode: SeasonRoomMode;
        pace: SeasonRoomPace;
