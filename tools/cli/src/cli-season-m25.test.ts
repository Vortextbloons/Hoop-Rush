...
describe('season m25 report schema round-trips', () => {
  ...
  it('parses a complete influence calibrate report payload and preserves every field', () => {
    const input = {
      ...
      targetsVersion: 'influence-targets-v3',
      calibrationSeeds: 12,
      validationSeeds: 4,
      seasonsSimulated: 16,
      balanceChecks: 3240,
      ...
      challengeEvaluations: 288,
      challengeSuccessRate: 0.5,
      expectedEarnedPerBlock: 1.75,
      capClampedShare: 0.05,
      ...
      gates: {
        ...
        expectedEarnedPerBlock: true,
        capClampedShare: true,
