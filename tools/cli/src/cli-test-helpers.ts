...
export async function expectExit2CleanManifestReport(commandArgs: string[], dataDir: string): Promise<void> {
...
export function writeManifestWithBracket(dir: string, bracketPath: string, bracketContent: string): string {
