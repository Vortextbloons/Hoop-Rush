import { SEASON_AI_VERSION, SEASON_ROSTER_GENERATION_VERSION, SEASON_ROSTER_TARGETS_VERSION, type SeasonRosterRole, type SeasonRosterTargets, } from '@hoop-rush/data-contracts';
