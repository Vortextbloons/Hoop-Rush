...
import { SEASON_EMPTY_COMMAND_LOG_DIGEST, buildSeasonRunReplayExport, seasonCommandLogDigest, seasonCommandLogEntrySchema, seasonCommandLogSchema, seasonPostseasonSummaryDigest, seasonPostseasonSummarySchema, type SeasonPostseasonSummary, } from '@hoop-rush/data-contracts';
...
function runWithChampion(champion: string) {
    ...
    const emptySeries = (seriesId: string, round: 'first-round' | 'conference-semifinal' | 'conference-final' | 'finals', conference: 'east' | 'west' | null, higherSeed: number | null, lowerSeed: number | null) => ({
        seriesId,
        round,
        conference,
        higherSeed,
