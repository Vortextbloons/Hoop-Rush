import { z } from 'zod';
import { SEASON_CAMPAIGN_TARGETS_VERSION, SEASON_EFFECT_TARGETS_LEGACY_VERSION, SEASON_EFFECT_TARGETS_VERSION, SEASON_FREE_AGENCY_TARGETS_VERSION, SEASON_INFLUENCE_TARGETS_VERSION, SEASON_INJURY_TARGETS_VERSION, SEASON_POSTSEASON_TARGETS_VERSION, SEASON_TRADE_TARGETS_VERSION, franchiseIdSchema, playerVersionIdSchema, reconstructionHoldoutSchema, reconstructionPriorsSchema, seasonFoulOutSchema, seasonForfeitTriggerSchema, seasonObjectiveIdSchema, seasonRotationDeviationReasonSchema, seasonRotationDeviationSchema, seasonRotationPresetSchema, seasonSubstitutionSchema, seasonUnitStintSchema, } from '@hoop-rush/data-contracts';
