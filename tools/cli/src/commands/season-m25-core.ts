import { SEASON_BLOCK_COUNT, SEASON_HEALTH_VERSION, SEASON_OBJECTIVE_CATALOG, SEASON_OBJECTIVE_VERSION, buildInitialPostseasonState, commandIdSchema, seasonHealthStateSchema, seasonObjectiveStateSchema, type FranchiseId, type Seed, type SeasonCandidateCheckpoint, type SeasonCheckpointState, type SeasonDraftCatalog, type SeasonEffectsState, type SeasonGameSummary, type SeasonHealthState, type SeasonInfluenceState, type SeasonObjectiveState, type SeasonRun, type SeasonTradeState, } from '@hoop-rush/data-contracts';
...
export function m25InitialInfluenceState(franchiseIds: readonly FranchiseId[]): SeasonInfluenceState {
                ...
                objectives: {
                    ...
                    selections: {
                        ...
                        [blockIndex]: {
                            ...
                            selectedByCommandId: commandIdSchema.parse(`season-block-${String(blockIndex)}-${String(state.acceptedCommandIds.length)}`),
