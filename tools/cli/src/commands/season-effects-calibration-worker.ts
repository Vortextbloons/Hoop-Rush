...
import { checkSeasonGameResult, createSeasonEffectsState, simulateSeasonGame, simulateSeasonGameWithEffects, } from '@hoop-rush/engine';
...
import { simulateSeasonEffectsGameFacts, withFixtureStamina, type SeasonEffectsGameFacts, } from './season-effects.ts';
...
function main(): void {
    ...
    const fixture = seasonGameFixtureSchema.parse(JSON.parse(readFileSync(fixturePath, 'utf8')) as unknown);
