...
import { gameResultSchema, gameSimulationInputSchema, type GameResult, type GameSimulationInput, } from '@hoop-rush/data-contracts';
...
function readInputJson<T>(path: string, schema: {
...
export function replay(args: {
    ...
    return makeReport('replay', { input: inputPath, expected: expectedPath }, { details, failures, payload });
}
