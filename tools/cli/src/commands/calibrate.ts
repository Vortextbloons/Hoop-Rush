...
import { DEFAULT_ERA_ID, POSITION_SLOTS, type EraSimulationProfile, type FranchiseEraPool, type GameResult, type GameSimulationInput, type SimulationTeam, playableSlotGroups, slotGroupOf, } from '@hoop-rush/data-contracts';
