import type { FixedFiveRoomMode, FixedFiveWorkerResultEntry, PlayerBoxScore, } from '@hoop-rush/data-contracts';
...
export function aggregateFixedFivePlayerStats(mode: FixedFiveRoomMode, entries: FixedFiveWorkerResultEntry[], p1TeamId = 'p1', p2TeamId = 'p2'): FixedFivePlayerStats {
