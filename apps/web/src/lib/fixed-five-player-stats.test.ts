...
function entry(tag: FixedFiveWorkerResultEntry['tag'], homeTeamId: string, homePlayers: PlayerBoxScore[], awayTeamId: string, awayPlayers: PlayerBoxScore[], gameNumber = 1): FixedFiveWorkerResultEntry {
    return {
        tag,
        game: {
            gameNumber,
