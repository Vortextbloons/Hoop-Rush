import { loadEraSimulationProfile, loadSeasonDraftCatalog, type EraSimulationProfile, type SeasonDraftCatalog, type SeasonPostseasonWorkerCompleteMessage, type SeasonPostseasonWorkerErrorMessage, type SeasonPostseasonWorkerStartRequest, } from '@hoop-rush/data-contracts';
...
import { createSeasonPostseasonRunner, type SeasonPostseasonSimulatorFn, } from '$lib/season/season-postseason-runner';
...
export function createSeasonPostseasonEngineSimulator(options: SeasonPostseasonEngineSimulatorOptions = {}): SeasonPostseasonSimulatorFn {
    return async (request: SeasonPostseasonWorkerStartRequest, onProgress): Promise<SeasonPostseasonWorkerCompleteMessage | SeasonPostseasonWorkerErrorMessage> => {
...
export function createFakeSeasonPostseasonRunner(): ReturnType<typeof createSeasonPostseasonRunner> {
