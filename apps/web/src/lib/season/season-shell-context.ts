import type { HoopRushManifest, PlayersIndexEntry, SeasonActiveRunIndex, SeasonDraftCatalog, SeasonFreeAgencyRoleExpectation, SeasonFreeAgencyState, SeasonHealthState, SeasonInfluenceState, SeasonInvalidRosterInterruption, SeasonLeague, SeasonObjectiveId, SeasonObjectiveState, SeasonPendingBlockCandidate, SeasonPostseasonRotationPayload, SeasonRun, SeasonSchedule, SeasonTeam, SeasonTradeState, } from '@hoop-rush/data-contracts';
import type { SeasonRunSnapshot } from '@hoop-rush/persistence';
import type { SeasonRunPlayerSlice } from './season-player-slice';
import type { BlockRunState, SeasonHubState, SeasonRunCommandError, SeasonSpendInfluencePurpose, } from './season-hub-state';
...
export interface SeasonRunShellData {
    ...
    acceptTradeOffer: (input: {
        windowIndex: number;
        offerId: string;
    }) => Promise<void>;
    declineTradeOffer: (input: {
        windowIndex: number;
        offerId: string;
    }) => Promise<void>;
    ...
    skipFreeAgentMarket: (input: {
        windowIndex: number;
    }) => Promise<void>;
    resolveFreeAgentMarket: (input: {
        windowIndex: number;
    }) => Promise<void>;
    forfeitInterruptedGame: () => Promise<void>;
    resumeBlock: () => Promise<void>;
    selectGmIdentity?: (input: {
        identity: string;
        focus: string | null;
    }) => Promise<void>;
    ...
    evolveGmCampaign?: (input: {
        offerId: string;
    }) => Promise<void>;
    openTradeInquiry?: (input: {
        windowIndex: number;
    ...
    walkAwayFromTrade?: (input: {
        windowIndex: number;
        inquiryId: string;
    }) => Promise<void>;
    purchaseTradeInquiry?: (input: {
        windowIndex: number;
    }) => Promise<void>;
