...
import { aggregateMechanismEvidence, deltaToPp, fatigueBand, fatiguePercent, projectedFatigueBand, } from './season-effects-view';
describe('M2.4 season effects view', () => {
    ...
    it('projects fatigue bands deterministically and monotonically with minutes', () => {
        ...
        expect(bands.indexOf(projectedFatigueBand(10000, 48, 45, 1))).toBeGreaterThanOrEqual(bands.indexOf('tired'));
