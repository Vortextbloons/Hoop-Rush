...
export interface GameplayTransport {
    loadBootstrap(roomId: string, transport: SeasonMultiplayerTransport, draft: SeasonDraftState, generation: SeasonLeagueGenerationResult): Promise<import('./season-gameplay-bootstrap').GameplayBootstrapResult>;
}
