import { buildSeasonRunReplayExport, humanFranchiseIdOf, type HoopRushManifest, type SeasonReplayAssetHashes, type SeasonRunReplayExport, } from '@hoop-rush/data-contracts';
