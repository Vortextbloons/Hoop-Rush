...
export function buildSeasonRunFromGeneration(input: BuildSeasonRunInput): SeasonRun {
    ...
    const run: SeasonRun = {
        ...
        authority: {
            kind: 'local-solo',
            soloFranchiseId: humanFranchiseIds[0] ?? null,
