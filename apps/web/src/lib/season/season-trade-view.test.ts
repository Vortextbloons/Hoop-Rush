...
import { humanTradeOffersOf, openWindowOf, tradeOfferViewModel, tradeResolvedAt, windowBlockIndexOf, } from './season-trade-view';
...
describe('tradeOfferViewModel', () => {
    it('renders players, value band, rationale, and chemistry facts', () => {
        const vm = tradeOfferViewModel(offer(), runWithRosters(), null, (franchiseId: string) => franchiseId === 'celtics' ? 'Boston Celtics' : franchiseId);
