import { blockIndexForRound, blockRoundRange, SEASON_BLOCK_COUNT, type SeasonGame, type SeasonGameSummary, } from '@hoop-rush/data-contracts';
...
export function scheduleBlockRows(games: readonly SeasonGame[], summaries: readonly SeasonGameSummary[], humanFranchiseId: string): ScheduleBlockRow[] {
