...
import { franchiseIdSchema, eraIdSchema, seasonKeySchema, playerIdSchema, contentHashSchema, idSchema, } from '@hoop-rush/data-contracts';
import type { SeasonCompletedSeason } from '@hoop-rush/persistence';
import { SEASON_EMPTY_COMMAND_LOG_DIGEST, SEASON_RUN_SCHEMA_VERSION, seasonCommandLogDigest, } from '@hoop-rush/data-contracts';
...
function completedSeason(): SeasonCompletedSeason {
    ...
    }).almanac.commandLogDigest = seasonCommandLogDigest((season as unknown as {
        commandLog: {
            entries: unknown[];
        };
