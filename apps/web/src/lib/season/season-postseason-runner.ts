import { SEASON_RUN_SCHEMA_VERSION, canonicalJson, seasonAlmanacDigest, seasonCommandLogDigest, seasonDigestHex, seasonPostseasonWorkerCancelRequestSchema, seasonPostseasonWorkerMessageSchema, seasonPostseasonWorkerWarmRequestSchema, seasonTradeGradeLogDigest, type SeasonAdvancePostseasonRejection, type SeasonAlmanac, type SeasonRun, type SeasonRunCommand, type SeasonRunStage, type SeasonScoreline, type SeasonSchedule, type SeasonPostseasonWorkerCompleteMessage, type SeasonPostseasonWorkerErrorMessage, type SeasonPostseasonWorkerProgressMessage, type SeasonPostseasonWorkerStartRequest, } from '@hoop-rush/data-contracts';
...
export function createSeasonPostseasonRunner(deps: SeasonPostseasonRunnerDeps = {}): SeasonPostseasonRunner {
    ...
    function fail(requestId: string, code: 'invariant-failure' | 'cancelled' | 'internal', message: string, seed: string | null): void {
        if (cancelled)
            return;
        emit({
            type: 'error',
    ...
    function emitComplete(requestId: string, runId: string, snapshot: SeasonRunSnapshot, promoted: boolean, decision: {
        nextDecision: 'rotation' | 'none';
        nextGameId: string | null;
        aiNextGameId: string | null;
    }): void {
