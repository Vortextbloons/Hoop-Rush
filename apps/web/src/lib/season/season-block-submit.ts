import { SEASON_BLOCK_VERSION, SEASON_RUN_SCHEMA_VERSION, commandIdSchema, franchiseIdSchema, type SeasonObjectiveId, type SeasonRotation, type SeasonSubmitBlockCommand, } from '@hoop-rush/data-contracts';
