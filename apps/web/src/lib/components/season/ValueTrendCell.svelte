...
const accent = $derived(trend.trend === 'rising' ? 'text-positive border-positive/30 bg-positive/10' : trend.trend === 'falling' ? 'text-destructive border-destructive/30 bg-destructive/10' : 'text-muted-foreground border-border bg-surface-2');
</script>
