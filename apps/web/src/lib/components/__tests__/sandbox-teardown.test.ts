...
import { contentHashSchema, eraIdSchema, franchiseIdSchema, playersIndexEntrySchema, } from '@hoop-rush/data-contracts';
...
vi.mock('$lib/data', async () => {
    ...
    for (let i = 0; i < 60; i += 1) {
        ...
        entries.push(playersIndexEntrySchema.parse({
