...
import type { HoopRushManifest, SeasonBlockRecap, SeasonEffectsState, SeasonGameSummary, SeasonRoster, } from '@hoop-rush/data-contracts';
...
const ROSTER: SeasonRoster = buildSeasonRosters(buildSeasonLeague(), 'roster-m24')[0] as SeasonRoster;
