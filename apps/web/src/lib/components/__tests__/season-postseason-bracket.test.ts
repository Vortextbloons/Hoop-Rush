...
function series(seriesId: string, round: 'first-round' | 'conference-semifinal' | 'conference-final' | 'finals', conference: 'east' | 'west' | null, higherSeed: number | null, lowerSeed: number | null, homeCourt: string | null, challenger: string | null, homeWins: number, challengerWins: number, winner: string | null, played: number): NonNullable<SeasonPostseasonState['bracket']>['finals'] {
    return {
...
function fixturePostseason(): SeasonPostseasonState {
    ...
    const conferenceBracket = (conference: 'east' | 'west') => ({
        ...
        firstRound: [
            series(`c${conference}1-8`, 'first-round', conference, 1, 8, `${conference}1`, `${conference}8`, 4, 1, `${conference}1`, 5),
            series(`c${conference}4-5`, 'first-round', conference, 4, 5, `${conference}4`, `${conference}5`, 2, 2, null, 4),
            series(`c${conference}3-6`, 'first-round', conference, 3, 6, `${conference}3`, `${conference}6`, 0, 0, null, 0),
            series(`c${conference}2-7`, 'first-round', conference, 2, 7, `${conference}2`, `${conference}7`, 4, 0, `${conference}2`, 4),
        ],
        semifinals: [
            series(`c${conference}1-5`, 'conference-semifinal', conference, 1, 5, `${conference}1`, `${conference}5`, 0, 0, null, 0),
            series(`c${conference}3-2`, 'conference-semifinal', conference, 3, 2, `${conference}3`, `${conference}2`, 0, 0, null, 0),
        ],
        conferenceFinal: series(`c${conference}1-2`, 'conference-final', conference, 1, 2, `${conference}1`, `${conference}2`, 0, 0, null, 0),
    });
    state.bracket = {
        schemaVersion: 1,
